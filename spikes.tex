...
%FIXME: CM recommends "Sometimes people also use this as an objective section, so if you have any specific types of roles that'd pique your interest more than others it can be a helpful mini-cover letter."
\end{rSection}
