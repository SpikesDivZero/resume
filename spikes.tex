...
\item After successfully achieving many of the goals I set out at DreamHost, I took a six-month sabbatical.
% FIXME: ^ Mom points out that I'm using the personal pronouns and possessives here. Got to fix that.
\item Learned some C\# and Unity to mentor someone new to development.
...
\item Reverse engineered software and embedded firmware.
